...
const double c[7]={61./1008., 0., 475./2016., 25./504., 125./1008., 25./1008., 11./2016.};
const double c_dot[7]={19./288.,0.,25./96.,25./144.,25./144.,25./96.,19./288.};
double dt_new=1.e100;

const double alpha[8]={0., 0.1, 0.2, 0.4, 0.6, 0.8, 1., 1.};
const double gamma[8][7]={	{0., 0., 0., 0., 0., 0.},
				{1./200., 0., 0., 0., 0., 0.},
				{1./150., 1./75., 0., 0., 0., 0.},
				{2./75., 0., 4./75., 0., 0., 0.},
